...
_form" name="appointment_form" class="mt-30" method="post" action="http://kodesolution.com/demo/wxyz/z/medikal/v3.0/demo/includes/appointment.php">
                    <div class="row">
                      <div class="col-sm-12">
                        <div class="form-group mb-10">
                          <input name="form_appontment_time" class="form-control required time-picker" type="text" placeholder="Symptoms" aria-required="true">
                        </div>
                      </div>
                    
  <div class="col-sm-12">
                        <div class="form-group mb-10">
                          <input name="form_appontment_time" class="form-control required time-picker" type="text" placeholder="disease" aria-required="true">
                        </div>
                      </div>
